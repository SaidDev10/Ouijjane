...
internal static class WebApplicationBuilderExtensions
{
    internal static WebApplicationBuilder AddConfigurations(this WebApplicationBuilder builder)
    {
        ...
        builder.Configuration.AddJsonFile("appsettings.json", optional: false, reloadOnChange: true)
                ...
                .AddJsonFile($"{settingsDirectory}/microservice.json", optional: false, reloadOnChange: true)
                .AddJsonFile($"{settingsDirectory}/microservice.{env.EnvironmentName}.json", optional: true, reloadOnChange: true)
                ...
                .AddJsonFile($"{settingsDirectory}/database.json", optional: false, reloadOnChange: true)
                .AddJsonFile($"{settingsDirectory}/database.{env.EnvironmentName}.json", optional: true, reloadOnChange: true)
